...
class S0503View(UpdateView):  # 更新
    ...
    def get_success_url(self):
        return reverse_lazy('benchamas:S05-05', kwargs={'pk': self.kwargs['pk']})
...
class S0505View(DetailView, DeleteView):
    model = GpuBench
    template_name = 'mas_benchmark_detail.html'
    success_url = reverse_lazy('benchamas:S05-01')
