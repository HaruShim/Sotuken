...
class Bottleneck(models.Model):
    ...
    balance = models.SmallIntegerField(
        verbose_name='バランス', choices=balancechoices, default=4,)
    wqhd = models.SmallIntegerField(
        verbose_name='WQHD', choices=wqhdchoices, default=4,)
    four_k = models.SmallIntegerField(
        verbose_name='4K解像度', choices=four_kchoices, default=4,)
    game_appropriate = models.SmallIntegerField(
        verbose_name='ゲーム適正', choices=game_appropriatechoices, default=8,)
    game_delivery = models.SmallIntegerField(
        verbose_name='ゲーム配信', choices=game_deliverychoices, default=4,)
    video_editing = models.SmallIntegerField(
        verbose_name='動画編集', choices=video_editingchoices, default=4,)
    encode = models.SmallIntegerField(
        verbose_name='エンコード', choices=encodechoices, default=4,)
