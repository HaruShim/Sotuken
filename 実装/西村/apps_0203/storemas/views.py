...
# 02/03
from .forms import S0202Form,Store_selecterAP
...
class S0201View(ListView):
    ...
    def mylist(request):
        ...
        if q_storename:
            ...
            print('q_storename',q_storename,object_list)
        if q_others:
            object_list = object_list.filter(
                Q(tel__icontains = q_storename)|
                Q(address__icontains = q_storename)
            )
            print('q_others',q_others,object_list)
        # print(object_list)
        ...
        try:
            ...
            object_list = paginator.page(1)
        context = {'st_list':st_list,'object_list':object_list}
